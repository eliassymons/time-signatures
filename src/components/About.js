    ...
    <div className="about-container">
      ...
      <div className="about-info">
        ...
        <p>
          ...
          division of beats in a piece of music. In traditional notation, the
          meter is indicated at the beginning of a piece of music. The most
          common grouping of beats, at least in Western music, is 4/4, where
          there are 4 beats (pulses) per grouping. Another common grouping style
          is 3/4 (used by waltzes) which has 3 beats per grouping.
        </p>
      </div>
    </div>
  );
